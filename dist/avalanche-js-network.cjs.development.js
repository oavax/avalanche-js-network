...
var BaseProvider = /*#__PURE__*/function () {
    ...
    this.middlewares = {
      request: {
        use: function use(fn, match) {
          ...
          _this.pushMiddleware(fn, exports.MiddlewareType.REQ, match);
        }
      },
      response: {
        use: function use(fn, match) {
          ...
          _this.pushMiddleware(fn, exports.MiddlewareType.RES, match);
        }
      }
    };
  ...
  _proto.pushMiddleware = function pushMiddleware(fn, type, match) {
    if (type !== exports.MiddlewareType.REQ && type !== exports.MiddlewareType.RES) {
      throw new Error('Please specify the type of middleware being added');
    }

    if (type === exports.MiddlewareType.REQ) {
...
var BaseSocket = /*#__PURE__*/function (_BaseProvider) {
  ...
  _proto.onReady = function onReady(event) {
    this.emitter.emit(exports.SocketConnection.READY, event);
    this.emitter.emit(exports.SocketState.SOCKET_READY, event);
  };

  _proto.onError = function onError(error) {
    this.emitter.emit(exports.SocketConnection.ERROR, error);
    this.emitter.emit(exports.SocketState.SOCKET_ERROR, error);
  ...
  _proto.onClose = function onClose(error) {
    ...
    this.emitter.emit(exports.SocketConnection.CLOSE, error);
    this.emitter.emit(exports.SocketState.SOCKET_CLOSE, error);
    this.removeAllSocketListeners();
    this.removeEventListener('*');
  };
...
var WSProvider = /*#__PURE__*/function (_BaseSocket) {
  ...
  _proto.createWebsocketProvider = function createWebsocketProvider(url, options) {
    ...
    if (typeof window !== 'undefined' && window.WebSocket) {
      ...
      return new websocket.w3cwebsocket(url, options.protocol, undefined, headers, undefined, options.clientConfig);
    }
  };
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (_this3.connected) {
        try {
          ...
          _this3.removeEventListener(exports.SocketConnection.ERROR);

          throw error;
        }
      }

      _this3.emitter.on(exports.SocketConnection.CONNECT, function () {
        try {
          _this3.connection.send(reqMiddleware(JSON.stringify(payload)));
        } catch (error) {
          // TODO !isConnecting then reconnect?
      ...
      _this3.emitter.on(exports.SocketConnection.ERROR, reject);
    });
  };
  ...
  _proto.onMessage = function onMessage(msg) {
    if (msg && msg.data) {
      ...
      try {
        result = avalancheJsUtils.isObject(msg.data) ? msg.data : JSON.parse(msg.data);

        if (avalancheJsUtils.isArray(result)) {
          event = result[0].id;
      ...
      this.emitter.emit(exports.SocketState.SOCKET_MESSAGE, result);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 13:
              ...
              this.emitter.emit(exports.SocketConnection.CONNECT);
  ...
  _proto.validate = function validate(response, payload) {
    if (avalancheJsUtils.isObject(response)) {
      if (response.error) {
...
var Provider = /*#__PURE__*/function () {
  ...
  _proto.onInitSetProvider = function onInitSetProvider(providerUrl) {
    if (typeof providerUrl === 'string') {
      return avalancheJsUtils.isHttp(providerUrl) ? new HttpProvider(providerUrl) : avalancheJsUtils.isWs(providerUrl) ? new WSProvider(providerUrl) : new HttpProvider(avalancheJsUtils.defaultConfig.Default.Chain_URL);
    }
...
var ResponseMiddleware = /*#__PURE__*/function () {
  ...
  _createClass(ResponseMiddleware, [{
    key: "getResult",
    get: function get() {
      return avalancheJsUtils.isObject(this.result) ? _extends({}, this.result, {
        responseType: 'result'
      }) : this.result;
    }
  }, {
    key: "getError",
    get: function get() {
      return avalancheJsUtils.isObject(this.error) ? _extends({}, this.error, {
        responseType: 'error'
      }) : this.error;
    }
  }, {
...
var Messenger = /*#__PURE__*/function (_AvalancheCore) {
  ...
  function Messenger(provider, chainType, chainId, config) {
    ...
    if (chainType === void 0) {
      chainType = avalancheJsUtils.defaultConfig.Default.Chain_Type;
    }

    if (chainId === void 0) {
      chainId = avalancheJsUtils.defaultConfig.Default.Chain_ID;
    }

    if (config === void 0) {
      config = avalancheJsUtils.defaultConfig;
    }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (rpcPrefix && avalancheJsUtils.isString(rpcPrefix) && rpcPrefix !== _this.chainPrefix) {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                if (returnType === void 0) {
                  returnType = exports.SubscribeReturns.all;
                }
              ...
              case 22:
                if (!(returnType === exports.SubscribeReturns.all)) {
                  _context2.next = 26;
                  break;
                }
              ...
              case 26:
                if (!(returnType === exports.SubscribeReturns.method)) {
                  _context2.next = 30;
                  break;
                }
              ...
              case 30:
                if (!(returnType === exports.SubscribeReturns.id)) {
                  _context2.next = 34;
                  break;
                }
    ...
    _this.setNetworkID(avalancheJsUtils.defaultConfig.Default.Network_ID); // set shardingProviders
    ...
    var _setShardingProviders = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
      ...
      return _regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              if (!(this.chainPrefix !== avalancheJsUtils.ChainType.Avalanche)) {
                _context4.next = 2;
                break;
              }
            ...
            case 2:
              _context4.prev = 2;
              _context4.next = 5;
              return this.send(exports.RPCMethod.GetShardingStructure, [], this.chainPrefix);
  ...
  return Messenger;
}(avalancheJsUtils.AvalancheCore);
...
var BaseBlockTracker = /*#__PURE__*/function (_Emitter) {
  ...
  _proto._newPotentialLatest = function _newPotentialLatest(newBlock) {
    ...
    if (currentBlock && avalancheJsUtils.isHex(currentBlock) && avalancheJsUtils.isHex(newBlock) && avalancheJsUtils.hexToNumber(newBlock) <= avalancheJsUtils.hexToNumber(currentBlock)) {
      return;
    }
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return this.messenger.send(exports.RPCMethod.BlockNumber, []);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              _context2.next = 11;
              return this.messenger.subscribe(exports.RPCMethod.Subscribe, ['newHeads']);
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              if (this.subscriptionId != null) {
                this.messenger.unsubscribe(exports.RPCMethod.UnSubscribe, [this.subscriptionId]);
...
var SubscriptionMethod = /*#__PURE__*/function (_WSProvider) {
    ...
    var _start = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              subscribePayload = this.constructPayload(exports.RPCMethod.Subscribe, this.param, this.options);
              _context.prev = 1;
              _context.next = 4;
  ...
  _proto.unsubscribe = function unsubscribe() {
    var unsubscribePayload = this.constructPayload(exports.RPCMethod.UnSubscribe, this.subscriptionId);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return this.messenger.send(exports.RPCMethod.GetPastLogs, [].concat(this.options), this.messenger.chainType, this.shardID);
...
//# sourceMappingURL=avalanche-js-network.cjs.development.js.map
